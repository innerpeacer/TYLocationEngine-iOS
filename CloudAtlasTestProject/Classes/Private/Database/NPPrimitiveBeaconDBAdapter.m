...
#import "NPPrimitiveBeaconDBConstants.h"
#import "FMDatabase.h"
#import "FMResultSet.h"

@interface NPPrimitiveBeaconDBAdapter()
{
...
@implementation NPPrimitiveBeaconDBAdapter
...
- (NSArray *)getAllPrimitiveBeacons
{
    ...
    while ([rs next]) {
        ...
        NPBeacon *beacon = [NPBeacon beaconWithUUID:nil Major:major Minor:minor Tag:tag];
...
- (NPBeacon *)getPrimitiveBeaconWithMajor:(NSNumber *)major Minor:(NSNumber *)minor
{
    ...
    if ([rs next]) {
        ...
        beacon = [NPBeacon beaconWithUUID:nil Major:major Minor:minor Tag:tag];
    }
