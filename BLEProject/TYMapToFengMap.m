...
{    
    double feng_x = [array[0] doubleValue];
    double feng_y = [array[1] doubleValue];
    double delta_x = [TYMapToFengMap getFengDeltaX:feng_x];
    double delta_y = [TYMapToFengMap getFengDeltaY:feng_y];
    
    double lamda = (delta_x * FENG_DELTA_2_Y - delta_y * FENG_DELTA_2_X) / (FENG_DELTA_1_X * FENG_DELTA_2_Y - FENG_DELTA_1_Y * FENG_DELTA_2_X);
    double miu = (delta_x * FENG_DELTA_1_Y - delta_y * FENG_DELTA_1_X) / (FENG_DELTA_2_X * FENG_DELTA_1_Y - FENG_DELTA_1_X * FENG_DELTA_2_Y);
...
+ (double)getFengDeltaX:(double)x
{
    return (x - FENG_MAP_X0);
}

+ (double)getFengDeltaY:(double)y
{
