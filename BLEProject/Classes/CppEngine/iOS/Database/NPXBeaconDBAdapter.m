...
- (NSArray *)getAllNephogramBeacons
{
    NSMutableArray *array = [[NSMutableArray alloc] init];
     ...
     NSString *sql = [NSMutableString stringWithFormat:@"SELECT distinct %@,%@,%@,%@,%@,%@ FROM %@", FIELD_GEOM, FIELD_UUID, FIELD_BEACON_MAJOR, FIELD_BEACON_MINOR, FIELD_FLOOR, FIELD_NP_BEACON_SHOPID, TABLE_BEACON];
