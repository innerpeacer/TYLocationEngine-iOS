...
//}
//
//NPXPoint CppUnionLane::snappedToLanes(Innerpeacer::BLELocationEngine::NPXPoint point)
//{
//    NPXPoint resultPoint(point);
//    
...
//        resultPoint = NPXPoint(snappedPoint->getX(), snappedPoint->getY(), point.getFloor());
//        delete snappedPoint;
//    }
//    
