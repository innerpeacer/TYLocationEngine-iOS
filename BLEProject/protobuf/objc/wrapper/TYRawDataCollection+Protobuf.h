//
//  TYRawDataCollection+Protobuf.h
//  BLEProject
//
...
@interface TYRawStepEvent(Protobuf)
...
@interface TYRawHeadingEvent(Protobuf)
...
@interface TYRawBeaconSignal(Protobuf)
...
@interface TYRawLocation(Protobuf)
...
@interface TYRawSignalEvent(Protobuf)
...
@interface TYRawDataCollection(Protobuf)
